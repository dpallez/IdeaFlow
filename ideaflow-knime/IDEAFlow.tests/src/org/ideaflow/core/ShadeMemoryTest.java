...
final class ShadeMemoryTest {
    @Test void usesImprovementWeightedLehmerAndArithmeticMeans() {
        ...
        final ShadeMemory.State updated = ShadeMemory.update(initial, List.of(
            new ShadeMemory.Success(0.5, 0.2, 1.0),
            new ShadeMemory.Success(1.0, 0.8, 3.0)));
    ...
    @Test void noSuccessLeavesMemorySlotAndIndexUntouched() {
