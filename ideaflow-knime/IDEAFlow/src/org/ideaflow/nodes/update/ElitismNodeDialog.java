...
final class ElitismNodeDialog extends DefaultNodeSettingsPane {
    ElitismNodeDialog() {
        final SettingsModelString mode =
            new SettingsModelString(ElitismNodeModel.CFG_MODE, "NSGA_II");
        final SettingsModelIntegerBounded divisions = new SettingsModelIntegerBounded(
            ElitismNodeModel.CFG_REFERENCE_DIVISIONS, 12, 1, 1000);
        ...
        final SettingsModelIntegerBounded minimum = new SettingsModelIntegerBounded(
            ElitismNodeModel.CFG_MINIMUM_SIZE, 4, 4, Integer.MAX_VALUE);
