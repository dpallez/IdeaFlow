...
public final class TrackProgressNodeFactory extends NodeFactory<TrackProgressNodeModel>
    ...
    @Override public TrackProgressNodeModel createNodeModel() { return new TrackProgressNodeModel(); }
    @Override protected int getNrNodeViews() { return 0; }
    @Override public NodeView<TrackProgressNodeModel> createNodeView(final int index,
        final TrackProgressNodeModel model) { return null; }
    @Override protected boolean hasDialog() { return true; }
    @Override protected NodeDialogPane createNodeDialogPane() { return new TrackProgressNodeDialog(); }
    ...
    @Override public org.knime.core.webui.node.view.NodeView createNodeView(final TrackProgressNodeModel model) {
