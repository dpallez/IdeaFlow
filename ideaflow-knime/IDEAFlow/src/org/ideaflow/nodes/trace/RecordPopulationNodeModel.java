...
public final class RecordPopulationNodeModel extends NodeModel {
  ...
  protected BufferedDataTable[] execute(
    ...
    final BufferedDataContainer trace = execution.createDataContainer(traceSpec(spec, names));
    long index = 0;
  ...
  private static List<String> valueNames(final DataTableSpec spec) throws InvalidSettingsException {
    ...
    for (DataColumnSpec column : spec) {
      ...
      if (!decisionColumns.contains(column.getName())
          && !base.contains(column.getName())
