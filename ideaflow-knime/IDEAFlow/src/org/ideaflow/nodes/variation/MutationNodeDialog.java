...
final class MutationNodeDialog extends DefaultNodeSettingsPane {
    MutationNodeDialog() {
        ...
        addDialogComponent(new DialogComponentStringSelection(strategy, "Strategy", "POLYNOMIAL",
            "GAUSSIAN", "BIT_FLIP", "RANDOM_RESET", "DE_RAND_1", "DE_BEST_1",
            "DE_CURRENT_TO_BEST_1", "DE_CURRENT_TO_PBEST_1"));
        ...
        addDialogComponent(new DialogComponentNumber(scale, "Gaussian scale (fraction of range)", 0.01));
