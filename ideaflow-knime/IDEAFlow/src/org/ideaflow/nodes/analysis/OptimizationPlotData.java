...
public record OptimizationPlotData(String title, String xLabel, String yLabel, boolean ecdf,
        boolean logX, boolean logY, List<Series> series) {
    public static OptimizationPlotData empty(final String title, final String xLabel,
