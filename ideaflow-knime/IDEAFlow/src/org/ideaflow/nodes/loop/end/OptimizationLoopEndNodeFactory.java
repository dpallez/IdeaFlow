...
public final class OptimizationLoopEndNodeFactory extends NodeFactory<OptimizationLoopEndNodeModel>
    ...
    @Override public OptimizationLoopEndNodeModel createNodeModel() { return new OptimizationLoopEndNodeModel(); }
    @Override protected int getNrNodeViews() { return 0; }
    @Override public NodeView<OptimizationLoopEndNodeModel> createNodeView(final int index,
        final OptimizationLoopEndNodeModel model) { return null; }
    @Override protected boolean hasDialog() { return true; }
    @Override protected NodeDialogPane createNodeDialogPane() { return new OptimizationLoopEndNodeDialog(); }
