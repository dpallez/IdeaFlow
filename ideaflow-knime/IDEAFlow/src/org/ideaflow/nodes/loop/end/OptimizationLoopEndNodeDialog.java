...
/** Classic-workbench configuration for optimization stopping targets. */
final class OptimizationLoopEndNodeDialog extends DefaultNodeSettingsPane {
  OptimizationLoopEndNodeDialog() {
    ...
    addDialogComponent(
        new DialogComponentString(targets, "Objective targets (encoded objective:value list)"));
    addDialogComponent(
        new DialogComponentStringSelection(
            rule, "When several targets are configured", "ALL", "ANY"));
    visibility.run();
  }
}
