...
public final class OptimizationLoopStartNodeModel extends NodeModel implements LoopStartNode {
    ...
    public BufferedDataTable currentArchive() {
        if (m_currentArchive == null) throw new IllegalStateException("The loop has no current archive yet.");
        return m_currentArchive;
    }


    private static BufferedDataTable empty(final DataTableSpec spec, final ExecutionContext execution) {
