...
public final class PopulationState {
  ...
  public static IdeaFlowState get(final DataRow row, final DataTableSpec spec)
    ...
    throw new InvalidSettingsException(
        "Invalid or missing IdeaFlow state at " + row.getKey() + ".");
  }

  public static void set(
      final DataCell[] cells, final DataTableSpec spec, final IdeaFlowState state)
      throws InvalidSettingsException {
  ...
  public static String run(final DataRow row, final DataTableSpec spec)
      throws InvalidSettingsException {
  ...
  public static long seed(final DataRow row, final DataTableSpec spec)
      throws InvalidSettingsException {
  ...
  public static long nfe(final DataRow row, final DataTableSpec spec) {
    ...
    if (index >= 0
        && !row.getCell(index).isMissing()
        && row.getCell(index) instanceof LongValue value) {
  ...
  public static void requireVisibleColumns(final DataTableSpec spec)
      throws InvalidSettingsException {
    require(spec);
