...
public final class Candidate {
    ...
    public Candidate(final String id, final double[] variables, final double[] objectives,
    ...
    public double[] variables() { return variables.clone(); }
    public double[] objectives() { return objectives.clone(); }
    public double constraintViolation() { return constraintViolation; }
