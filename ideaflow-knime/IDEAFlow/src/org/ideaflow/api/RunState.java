...
public record RunState(
    ...
    public RunState {
        ...
        algorithmState = Collections.unmodifiableMap(new LinkedHashMap<>(
                algorithmState == null ? Map.of() : algorithmState));
    }
    ...
    public RunState account(final long count) {
        ...
        return new RunState(runId, populationId, next, maxEvaluations, startedAtMillis,
                stopped || budgetReached, budgetReached ? "max_evaluations" : stopReason, algorithmState);
    }
}
