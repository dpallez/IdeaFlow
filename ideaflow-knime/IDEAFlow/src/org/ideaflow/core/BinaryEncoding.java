...
public final class BinaryEncoding {
  ...
  public static double decode(
      final long storedCode, final int bits, final double lower, final double upper) {
    ...
    if (storedCode < 0 || storedCode > denominator)
      throw new IllegalArgumentException("Code exceeds bit range.");
