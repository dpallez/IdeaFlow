...
/** Describes the problem shapes and variable types supported by a strategy. */
public record CapabilityDescriptor(
  ...
  public CapabilityDescriptor {
    ...
    if (minimumObjectives < 1)
      throw new IllegalArgumentException("Minimum objectives must be positive.");
  }
